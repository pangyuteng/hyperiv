...
dtstamp_list = full_dtstamp_list[:20]
...
def gen_data(dstamp,option_type):
    ticker = "SPXW"
    ...
    print(df.shape)
    df=df[(df.underlying_symbol==ticker)&(df.option_type==option_type)]
    print(df.shape)
...
if __name__ == "__main__":
    ...
    call_h5_file = "/mnt/hd2bak/scratch/spx_w_ref_call_LARGE.h5" # TODO: ask,bid
    put_h5_file = "/mnt/hd2bak/scratch/spx_w_ref_put_LARGE.h5"
